...
const newsItems: NewsItem[] = [
  {
    ...
    content: (
      <>
        Congratulations to S&ouml;ren and Xuemei for having the first paper generated by AI-Mandel,{" "}
        <a
          href="https://arxiv.org/abs/2511.11752"
          target="_blank"
          rel="noreferrer"
        ...
        , accepted in the respected peer-reviewed physics journal{" "}
        <a
          href="https://journals.aps.org/prresearch/accepted/10.1103/f415-kgwr"
          target="_blank"
          rel="noreferrer"
        ...
        . The paper started by us asking AI-Mandel to find{" "}
        <strong>&quot;something interesting in quantum physics&quot;</strong>. To the best of my
        knowledge, it&apos;s the first peer-reviewed physics paper ever where the idea and execution
        were automated, in our case using a multi-agentic LLM system with access to intelligent tools.
      </>
    ),
  },
  {
  ...
  },
  {
    ...
    content: (
      <>
        Marcello, Pontus, Jonathan, and Mario participated in the &quot;Future of Science&quot;
        workshop at the{" "}
        <a
          href="https://www.iqoqi-vienna.at/"
          target="_blank"
          rel="noreferrer"
          className="challenge-inline-link"
        >
        ...
        with the other co-authors, together with researchers from{" "}
        <a
          href="https://bbqlab.org/"
          target="_blank"
          rel="noreferrer"
          className="challenge-inline-link"
        >
        ...
        ,{" "}
        <a
          href="https://research.tuni.fi/eqo/"
          target="_blank"
          rel="noreferrer"
          className="challenge-inline-link"
        >
          Robert Fickler&apos;s group
        </a>
        , and{" "}
        <a
          href="https://quantumimaging.fuw.edu.pl/"
          target="_blank"
          rel="noreferrer"
          className="challenge-inline-link"
        >
          Radek Lapkiewicz&apos;s group
        </a>
        .
      </>
    ),
  ...
  },
  {
    ...
    content: (
      <>
        Mario joined as an Associate Editor of APS&apos;s (American Physical Society) new journal{" "}
        <a
          href="https://journals.aps.org/prxintelligence/staff"
          target="_blank"
          rel="noreferrer"
          className="challenge-inline-link"
        >
        ...
        . PRX Intelligence was founded in November 2025, with submissions starting in February
        2026, by Anatole von Lilienfeld, who had previously already founded IOP&apos;s community
        journal Machine Learning: Science &amp; Technology. PRX Intelligence is a community-driven
        journal, with active scientists at the Chief Editor, Deputy Editors, and Associate Editor
